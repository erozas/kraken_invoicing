module KrakenInvoicing
  class Resource
    ...
    def post_request(url, body: {}, headers: {})
      handle_response client.connection.post(url, body[:body], default_headers.merge(headers))
    end
    ...
    def default_headers
      { Authorization: "Bearer #{client.auth_token}", "Content-Type": 'application/json' }
    end
